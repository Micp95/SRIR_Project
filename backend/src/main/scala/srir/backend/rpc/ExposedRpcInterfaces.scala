package srir.backend.rpc

import srir.backend.rpc.auth.AuthEndpoint
import srir.backend.rpc.i18n.TranslationsEndpoint
import srir.backend.rpc.secure.SecureEndpoint
